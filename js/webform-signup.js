		...
		jQuery.getJSON(url, function(data){
			...
			if(data.is_error == 0){
				...
				for(var slotId in slots){
					mark = true;
					booked = '';
					if(slots[slotId].slot_date != null && slots[slotId].slot_date != ''){
						booked = "booked";
					}
					var temp = "<li class='item "+ booked +"'>";
					...
					if(ms >= now.getTime()){
						...
						temp += "<div class='last left'><input type='radio' name='group' value='"+slotId+"' disabled></div>";
					}
					temp += "</li>";
